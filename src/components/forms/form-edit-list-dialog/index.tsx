		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[425px]">
				<DialogHeader>
					...
					<DialogDescription>Edite o nome da lista</DialogDescription>
				</DialogHeader>
				<form id="form-edit-list" onSubmit={handleSubmit(onSubmit)}>
					<FieldGroup className="pb-3">
						<Field>
							<FieldLabel htmlFor="filename">Nome da lista:</FieldLabel>
							<Input
								{...register("name")}
								className={cn(
									errors.name && [
