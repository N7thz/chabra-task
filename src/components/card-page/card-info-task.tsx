...
import { SelectPriority } from "@/components/forms/form-create-card/select-priority"
...
export const CardInfoTask = ({
	card: { description, priority, status, ownersId, tasks },
}: {
	card: CardComplete
}) => {
		...
		<ScrollArea className="h-100 p-2">
			...
			<Card className="size-full border-none bg-transparent">
				<CardContent className="space-y-4">
					...
					<Label htmlFor="describe" className="flex flex-col gap-2">
						Descrição:
						<Textarea
							id="describe"
